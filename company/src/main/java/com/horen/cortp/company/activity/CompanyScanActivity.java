 ...
 */
public class CompanyScanActivity extends FragmentActivity implements View.OnClickListener,SensorEventListener {
    public final static int REQUEST = 66;
    private boolean isLightEnable = false; // 是否开启闪关灯，默认是关闭的
    ...
    public static void startActivityForResult(Activity activity) {
        ...
        intent.setClass(activity, CompanyScanActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jaydenxiao.common.R.layout.activity_qr_scan);
        // 透明状态栏
        ...
        AnimationUtils.scanLineAnim(ivScanLine, 0,DisplayUtil.dip2px(239),2000);
        /**
         * 初始化界面之后>>>
         * 执行扫面Fragment的初始化操作
         */
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.zxing_back) {
            ...
            if (isLightEnable) { // 开启闪关灯状态，关闭
                ...
                tvLight.setTextColor(getResources().getColor(R.color.color_main_color));
            }
        }
    }
    @Override
