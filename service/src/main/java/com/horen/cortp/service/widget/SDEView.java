...
public class SDEView extends AppCompatEditText {
    private boolean isListener = false;
    private Drawable mDrawable;

    public SDEView(Context context) {
        this(context, null);
    }

    public SDEView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initListener() {
        setOnFocusChangeListener(new SDEFocuChangeListener(this));
        addTextChangedListener(new SDETextChangeListener(this));
    }
